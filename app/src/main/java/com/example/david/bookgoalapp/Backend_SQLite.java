...
public class Backend_SQLite extends SQLiteOpenHelper implements IBackend {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(BookGoalMySQLiteDBDiffinition.CREATE_TABLE_BOOKGOAL_CMD);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion,int newVersion) {
        db.execSQL("drop table if exists " +
                BookGoalMySQLiteDBDiffinition.TABLE_BOOKGOAL_NAME
                    );
        onCreate(db);
    }
    ...
    private BookGoal getBookGoalFromCursor(Cursor c) throws Exception {
        if(! c.isAfterLast()) {
            ...
            b.setId(c.getInt(             c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_ID)));
            b.setName(c.getString(        c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_NAME)));
            b.setStart_pos(c.getInt(      c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_START_POS)));
            b.setEnd_pos(c.getInt(        c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_END_POS)));
            b.setCur_pos(c.getInt(        c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_CUR_POS)));
            b.setPos_type(c.getString(c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_POS_TYPE)));
            b.setRate(c.getInt(           c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_RATE)));
            b.setStating_date(c.getString(c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_START_DATE)));
            b.setColor(c.getInt(          c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_COLOR)));
            try {
                b.setAt_time(new Time(c.getString(c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_AT_TIME))));
            } catch (Exception e) {
                throw new Exception(String.valueOf(R.string.couldn_t_parse_time_got_from_data_base));
            }
            b.setEnabled(c.getInt(c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_ENABLED)) == 1);
            b.setNote(c.getString(c.getColumnIndex(BookGoalMySQLiteDBDiffinition.BookGoalTableDiffinition.COLUMN_NOTE)));
            return b;
        }
        return null;
    }
